 ...
 * v3.0.68 - Use .active class instead of inline display (CSS uses !important)
 * 
 * CHANGELOG v3.0.68:
...
(function() {
    ...
    console.log('[TWR RolesTabs] Loading v3.0.68 (.active class fix)...');
    ...
    console.log('[TWR RolesTabs] Module loaded v3.0.68 (.active class fix) - exposed at window.TWR.RolesTabs');
